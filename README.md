...
```bash
git clone https://github.com/caiocesarmb/Livraria-LP2.git
cd Livraria-LP2/Trabalho-de-LP-2
```
...
Caio César de Moarais Batista  
Erik Jhonatan Nascimento da Cunha  
Everton Lucas Santana de Andrade  

## 🔗 Links Úteis

- **Repositório:** [GitHub - Livraria-LP2](https://github.com/caiocesarmb/Livraria-LP2.git)
